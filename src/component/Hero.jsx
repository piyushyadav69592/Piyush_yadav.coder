...
const Hero = () => {
    return (
        <motion.div
            ...
            className='min-h-screen w-full bg-dark-100/90 flex flex-col items-center text-white sm:flex-row'
        >
            {/* left pannel */}

            <div className='w-full flex   item-center  min-h-[60vh] p-15 pt-24 sm:w-1/2 sm:h-screen sm:pt-50'>
            <div>
            ...
            <div className='w-[60vh] min-h-[80vh]  flex item-center justify-center md:mt-[7rem] lg:mt-[8rem] lg:ml-[8rem] '>
                <div className='h-60 w-80  rounded-tl-[10vw] '>
                    <img src={assets.profileImg} alt="profile img" className='rounded-[10vw] shadow-[15px_5px_30px_10px_rgba(147,51,234,0.5)] shadow-purple-500/80 ' />
                </div>
            </div>
        </motion.div>
    )
